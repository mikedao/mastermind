...
class Highscore
  ...
  def print_top_ten
    ...
    @top_ten.each_with_index { |score, i| outstream.puts top_ten_layout(i)  }
  end

  def top_ten_layout(i)
    "#{(i+1).to_s.center(20)} #{score[0].to_s.center(20)} #{score[1].to_s.center(20)}  #{score[2].to_s.center(20)} #{score[3].to_s.center(20)}"
  end
