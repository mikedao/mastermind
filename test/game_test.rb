...
class GameTest < Minitest::Test
  ...
  def test_correct_colors
    game = Game.new
    assert_equal 0, game.correct_colors(["r", "g", "b", "y"],["r", "g", "b", "y"])
    assert_equal 1, game.correct_colors(["r", "r", "y", "y"],["y", "b", "b", "b"])
    assert_equal 1, game.correct_colors(["r", "r", "y", "y"],["r", "b", "b", "r"])
  end
